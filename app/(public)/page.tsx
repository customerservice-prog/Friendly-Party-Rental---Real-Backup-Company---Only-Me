    ...
    <div>
      ...
      <ComicBookBackground className="py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/order-by-date" className="btn-gold inline-block">Book Your Rentals Online</Link>
        </div>
      </ComicBookBackground>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        <div>
          ...
          <p className="text-body text-sm">From intimate backyard gatherings to large outdoor weddings, our pole tents come in sizes from 10x10 to 40x80. All tents include professional delivery, setup, and breakdown for most Onondaga County locations. Our tents are inspected and cleaned before every rental.</p>
        </div>
        <div>
          <h2 className="text-xl font-bold text-dark mb-3">Table and Chair Rentals</h2>
          <p className="text-body text-sm">We offer white plastic folding chairs, resin chairs with pads, gold and white Chiavari chairs, 6ft and 8ft folding tables, and round banquet tables. Perfect for weddings, graduations, corporate events, and backyard parties throughout Syracuse and Central New York.</p>
        </div>
        <div>
          <h2 className="text-xl font-bold text-dark mb-3">Bounce House Rentals</h2>
          <p className="text-body text-sm">Our commercial-grade bounce houses, water slides, and combo inflatables start at $199. All inflatables are cleaned and sanitized before every rental. Generator rentals available for park setups starting at $125.</p>
        </div>
        <div>
          <h2 className="text-xl font-bold text-dark mb-3">Linens &amp; Concession Rentals</h2>
          <p className="text-body text-sm">Complete your event with white table linens, napkins, and sashes. Add fun with our popcorn machines, cotton candy machines, snow cone machines, and other concession equipment rentals.</p>
        </div>
        <div>
          <h2 className="text-xl font-bold text-dark mb-3">Wedding Rentals in Syracuse</h2>
          <p className="text-body text-sm">Our wedding packages include everything from intimate elopements to all-inclusive premium receptions. Packages include tents, tables, chairs, linens, dance floors, lighting, and professional setup and breakdown.</p>
        </div>
      </section>
